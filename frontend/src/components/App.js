...
function App() {
  ...
  const [infoTooltipPopupStatusSuccess, setInfoTooltipPopupStatusSuccess] =
    useState(false);
  ...
  function handleUpdateUser(profile) {
    function makeRequest() {
      return api.editProfile(profile).then(setCurrentUser);
    }
  ...
  function handleUpdateAvatar(link) {
    function makeRequest() {
      return api.editAvatar(link).then(setCurrentUser);
    }
        ...
        <AppContext.Provider value={isLoading}>
          <CurrentUserContext.Provider value={currentUser}>
            ...
            <Routes>
              ...
              <Route
                path="/signin"
                element={<Login isSignup={false} onSubmit={onLogin} />}
              />
              <Route
                path="/signup"
                element={<Register isSignup={true} onSubmit={onSignup} />}
              />
